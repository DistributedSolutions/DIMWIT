...
type IWriterHelper interface {
	...
	InitiateChannel(ch *common.Channel) (hash *primitives.Hash, err *util.ApiError)
	...
	AddContent(con *common.Content) (hash *primitives.Hash, err *util.ApiError)
...
func (fakeChannelTool *FakeWriterHelper) InitiateChannel(ch *common.Channel) (hash *primitives.Hash, err *util.ApiError) {
	return nil, nil
}
...
func (fakeChannelTool *FakeWriterHelper) AddContent(con *common.Content) (hash *primitives.Hash, err *util.ApiError) {
	return nil, nil
}
